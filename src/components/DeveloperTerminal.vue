...
<div class="flex items-center justify-center"> <!-- Contenedor padre (centrado vertical/horizontal) -->
  <div class="code-container font-mono flex flex-col w-full min-w-[700px]"> <!-- Elimina justify-center/items-center aquí -->
...
const fullCode = `const developer = {
  ...
  learning: ['Dart'],
  passions: ['Building intuitive web experiences', 'Playing fútbol xD'],
};`;
